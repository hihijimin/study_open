...
5. GPU (nvidia titan rtx ) 일때  설치 순서
- http://www.nvidia.com/Download/Find.aspx?lang=en-us 들어가서 해당 버전 **확인** 한다.  
![image](https://user-images.githubusercontent.com/56099627/98781334-7e8f7a00-2439-11eb-92d3-510ea3985b3c.png)  
- $ sudo apt-get install nvidia-driver-440  
(패키지 이름은 NVIDIA 드라이버 버전이 410 미만이면 nvidia-xxx, 이상이면 nvidia-driver-xxx의 형식임)  
- $ sudo apt-get install dkms nvidia-modprobe  
(설치가 끝나면 NVIDIA kernel module의 로드를 도와주는 modprobe 패키지를 설치함)  
