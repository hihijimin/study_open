...
<img src="https://latex.codecogs.com/svg.latex?y=\left\{\begin{matrix} x (x>0) \\ 0 (x\leq 0) \end{matrix}\right." title="y=\left\{\begin{matrix} x (x>0) \\ 0 (x\leq 0) \end{matrix}\right." />  
