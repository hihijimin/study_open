...
<img src="https://latex.codecogs.com/gif.latex?\eta&space;x_{0}=x_{0}-\eta&space;\frac{\partial&space;f}{\partial&space;x_{0}}" title="\eta x_{0}=x_{0}-\eta \frac{\partial f}{\partial x_{0}}" />  
