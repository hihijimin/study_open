...
### occlusion experiments
<p align="center"><img width="40%" src="https://user-images.githubusercontent.com/56099627/71151569-650c9f00-2277-11ea-9070-cec555aaab52.png" /></p> 
(그림) 은닉을 통해 실험한것인데 인풋이미지에 일부를 가려서(정사각형으로 은폐한 부분) 해당 객체를 인식할 수 있는지 보았을때 현저히 인식이 떨어지는 것을 확인 할 수 있음. **은폐한 위치에** 따라서 객체를 얼마나 잘 classify 하는지(얼마나 그 확률에 얼마나 변화가 있는지) 히트맵을 통해 확인하는 실험을 함
